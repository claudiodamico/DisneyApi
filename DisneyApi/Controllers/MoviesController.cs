...
namespace DisneyApi.Presentation.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public ActionResult GetAllMovies(string name = null, int? genre = null, string order = null)
        {
            try
            {
        ...
        public ActionResult CreateMovie([FromBody] PeliculaDtoForCreationOrUpdate pelicula)
        {
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public ActionResult UpdateMovie(int id, [FromBody] PeliculaDtoForCreationOrUpdate movie)
        {
            try
            {
                if (movie == null)
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public ActionResult GetMovieWithDetails(int id)
        {
            try
            {
